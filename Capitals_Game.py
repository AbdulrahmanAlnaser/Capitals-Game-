    ...
    if capital[0] == last_letter and capital in Country_Capitals:
        ...
        for correct_capital in Country_Capitals:
            if correct_capital[0] == last_letter:
                print(f"Wrong, '{capital}' is not correct, you can say {correct_capital.title()} the capital of {Country_Capitals[correct_capital].title()}")
                break
